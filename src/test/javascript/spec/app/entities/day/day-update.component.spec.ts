...
import DayUpdateComponent from '@/entities/day/day-update.vue';
import DayClass from '@/entities/day/day-update.component';
...
describe('Component Tests', () => {
  describe('Day Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<DayClass>(DayUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.day = entity;
        dayServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(dayServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.day = entity;
        dayServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(dayServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        dayServiceStub.retrieve.resolves([foundDay]);
